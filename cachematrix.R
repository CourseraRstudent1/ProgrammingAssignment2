...
# -------------------------------
# 1) Generates a matrix and a cache for storing the inverse of that matrix.
...
makeCacheMatrix <- function(x = matrix()) {
        ...
        getinverse <- function() {i}                                            # the getinverse() function returns the cached inverse of the matrix (if it has been cached) e.g. matrix1$getinverse().
        list(set = set,... =
             get = get,
